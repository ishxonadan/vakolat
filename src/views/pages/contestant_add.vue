...
const saveContestant = async () => {
  ...
  try {
    await apiService.post('/contestants', contestant.value);
    
    toast.add({
      severity: 'success',
      summary: 'Muvaffaqiyat',
      detail: 'Sayt muvaffaqiyatli qo\'shildi',
      life: 3000
    });
    ...
    toast.add({
      severity: 'error',
      summary: 'Xato',
      detail: 'Saytni saqlashda xatolik yuz berdi',
      life: 3000
    });
  } finally {
...
<template>
  <div>
    <div class="flex items-center p-4 bg-white dark:bg-zinc-800 shadow-md rounded-lg mb-6">
      ...
      <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Yangi sayt qo'shish</h1>
    </div>

    <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-md p-6">
      <form @submit.prevent="saveContestant" class="space-y-6">
        <!-- Basic Information -->
